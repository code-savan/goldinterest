    ...
    <section className="relative overflow-hidden h-[100dvh] min-h-[620px] lg:min-h-[660px] flex flex-col">
      ...
      <div className="absolute inset-0 bg-[#0A0A0A]">
        <img
          ...
          sizes="100vw"
          alt="Wallpaper packs and framed wall art in a warm modern interior — Gold Lifestyle"
        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-20 xl:gap-28 items-center w-full">
          ...
          <div className="relative">
            <div className="bg-white/[0.92] backdrop-blur-md p-6 lg:p-8 xl:p-9 max-w-[520px] shadow-[0_12px_40px_rgba(0,0,0,0.10)]">
              <div className="text-[10px] tracking-[0.24em] uppercase text-[#8C6A2F]/80 font-medium">Gold Lifestyle — Maison · Est. 2024</div>
              <h1 className="font-serif text-[34px] sm:text-[40px] lg:text-[48px] leading-[0.9] tracking-[-0.03em] font-light mt-3.5 text-[#1A1A1A]">
                Everything <br />
                <span className="italic font-normal text-[#8C6A2F]/90">for your</span> <br />
                Space
              </h1>
              <p className="text-[13px] leading-6 text-[#6B6B6B]/90 mt-4 max-w-[380px]">
                Wallpapers, printable posters, framed wall art & apparel — quiet luxury, Printer Star finish, heavyweight cotton,
                gold details. Free shipping — all orders.
              </p>
              ...
              <div className="flex items-center gap-3 mt-7 pt-5 border-t border-[#E8E6E1]/60">
                <div className="flex -space-x-2">
                  <img src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=100&auto=format&fit=crop&q=60" alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" />
                  <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&auto=format&fit=crop&q=60" alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" />
                  <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=60" alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" />
                </div>
            ...
            <div className="hidden lg:flex absolute -right-8 -bottom-6 bg-[#0A0A0A]/85 backdrop-blur-sm text-white/90 px-5 py-3 items-center gap-3 shadow-lg">
              ...
              <div>
                ...
                <div className="text-[13px] font-medium">All orders — worldwide</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block h-[520px] xl:h-[560px]">
            ...
            <div className="absolute top-0 right-6 bg-white/95 backdrop-blur-sm p-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.12)] w-[240px]">
              <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&auto=format&fit=crop&q=60" alt="" className="w-full h-[150px] object-cover opacity-95" />
            ...
            <div className="absolute bottom-0 left-2 bg-white/95 backdrop-blur-sm p-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.12)] w-[220px]">
              <img src="https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&auto=format&fit=crop&q=60" alt="" className="w-full h-[140px] object-cover opacity-95" />
              <div className="pt-2.5">
                <div className="text-[10px] tracking-[0.14em] uppercase text-[#8C6A2F]/80">Apparel</div>
                <div className="text-[13px] font-medium">Essential Hoodie — Bone</div>
                <div className="text-[11px] text-[#6B6B6B]/70">450gsm · S–3XL</div>
              </div>
            </div>
          ...
          <div className="lg:hidden mt-6 space-y-3">
            ...
            <div className="bg-white/95 backdrop-blur-sm p-2.5 shadow-[0_8px_24px_rgba(0,0,0,0.12)] flex gap-3 items-center">
              <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&auto=format&fit=crop&q=60" alt="" className="w-20 h-20 object-cover shrink-0" />
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-[#6B6B6B]/70">3 rolls · Free shipping</div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white/95 backdrop-blur-sm p-2.5 shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
                <img src="https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&auto=format&fit=crop&q=60" alt="" className="w-full h-24 object-cover" />
                <div className="text-[11px] font-medium mt-2">Hoodie — From $89</div>
                <div className="text-[10px] text-[#6B6B6B]/70">S–3XL · 450gsm</div>
              </div>
      ...
      <div className="relative mt-auto">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 flex flex-wrap justify-center lg:justify-between items-center gap-3 lg:gap-8 py-3.5 lg:py-4 text-center text-[10px] sm:text-[10.5px] tracking-[0.16em] uppercase text-white/20">
          ...
          <span>Printer Star — Made in EU</span>
          <span className="hidden lg:inline w-px h-3 bg-white/[0.02]" />
          <span className="hidden lg:inline">Frame Wall Art — Oak</span>
          <span className="hidden lg:inline w-px h-3 bg-white/[0.02]" />
          <span className="hidden lg:inline">All Sales Final — No Returns</span>
        </div>
      </div>
    </section>
  );
